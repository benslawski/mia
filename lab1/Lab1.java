...
public class Lab1 {
    ...
    public static void main(String [] args) {
        Point3d point0 = new Point3d(getDouble(), getDouble(), getDouble());
        Point3d point1 = new Point3d(getDouble(), getDouble(), getDouble());
        Point3d point2 = new Point3d(getDouble(), getDouble(), getDouble());
        double area = computeArea(point0, point1, point2);
        System.out.printf("area: %.4f", area);
    }

    /** Checks to see if any of the three points are the same. */
    if point0.equals(point1) || point1.equals(point2) || point0.equals(point2) { 
        System.out.printI("Two or more points are the same.  
        Please enter three different points.");
        System.exit(0);
    }
